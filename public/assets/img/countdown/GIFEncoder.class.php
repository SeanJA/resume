...
class AnimatedGif {
     ...
     * @param int $transparent_colour_red Int value of the transparent red
     * @param int $transparent_colour_green Int value of the transparent green
     * @param int $transparent_colour_blue Int value of the transparent blue
     */
     ...
     * @return resource The built animated gif
     */
    ...
    /**
     * Display the animated gif here, sets the header and echo's out the image
     */
    function display() {
        //late footer add
        $this->addFooter();
